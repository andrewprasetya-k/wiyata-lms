...
func (r *asgMediaRepoStub) GetByOwner(_ domain.OwnerType, _ string) ([]*domain.Media, error) {
	return nil, nil
}
...
func (r *asgEnrRepoStub) GetByClassAndSchoolUser(_, _ string) (*domain.Enrollment, error) {
	return nil, nil
}
...
func (r *asgEnrRepoStub) HasTeacherSubjectClassAssignment(_, _, _ string) (bool, error) {
	return false, nil
}
...
func (r *asgEnrRepoStub) UserEnrolledInClassAsRole(_, _, _, _ string) (bool, error) {
	return false, nil
}
